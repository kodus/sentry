...
test(
    ...
    function () {
        ...
        eq($client->testFormat(empty_closure()), '{Closure in ' . __DIR__ . DIRECTORY_SEPARATOR . 'test.fixtures.php(64)}');
...
test(
    ...
    function () {
        ...
        eq($body["transaction"], __DIR__ . DIRECTORY_SEPARATOR . "test.fixtures.php#18", "can capture 'transaction' (filename and line-number)");
        ...
        eq($inner_frames[0]["lineno"], 36, "can capture line-numbers");
        eq($inner_frames[1]["lineno"], 16);
        eq($inner_frames[2]["lineno"], 28);
        eq($inner_frames[3]["lineno"], 25, "can capture line-number of failed call-site");
