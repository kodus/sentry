...
test(
    ...
    function () {
        ...
        eq($client->testFormat(empty_closure()), '{Closure in ' . __DIR__ . DIRECTORY_SEPARATOR . 'test.fixtures.php(63)}');
...
test(
    ...
    function () {
        ...
        eq($body["transaction"], __DIR__ . DIRECTORY_SEPARATOR . "test.fixtures.php#17", "can capture 'transaction' (filename and line-number)");
        ...
        eq($inner_frames[0]["lineno"], 35, "can capture line-numbers");
        eq($inner_frames[1]["lineno"], 15);
        eq($inner_frames[2]["lineno"], 27);
        eq($inner_frames[3]["lineno"], 24, "can capture line-number of failed call-site");
